    ...
    <div class="container">
        ...
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if($precio == ''){
                    echo "<h2>El precio es obligatorio</h2>";
                } else{
                    ...
                    if ($resultado -> num_rows == 0) {
                        echo "<h2>El nombre ya esta en uso/h2>";
                    } else {
                ...
                if($descripcion == ''){
                    echo "<h2>La descripción es obligatoria</h2>";
                } else {
                ...
                if ($correcto_nombre && $correcto_precio && $correcto_categoria && $correcto_descripcion && $correcto_stock) {
                    ...
                    if ($resultado -> num_rows != 0) {
                        ...
                        $sql = "INSERT INTO productos (nombre_producto, precio, categoria,descripcion, stock, imagen) 
                                VALUES ('$nombre','$precio','$categoria', '$descripcion','$stock','../Imagenes/$imagen' );";
                        $_conexion -> query($sql);
                    }
                }
            }
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select name="categoria">
                    <option value="categorias" selected disabled hidden>---CATEGORIA---</option>
                    <?php
