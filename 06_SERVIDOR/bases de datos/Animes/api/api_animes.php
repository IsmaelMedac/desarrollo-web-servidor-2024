<?php
    ...
    function manejarGet($_conexion){
        ...
        if(isset($_GET["nombre_estudio"])){
            $sql = "SELECT * FROM estudios WHERE nombre_estudio = :nombre_estudio";
            $stmt = $_conexion -> prepare($sql);
            $stmt -> execute([
    ...
    function manejarPost($_conexion, $entrada){
        ...
        $sql = "INSERT INTO animes (titulo, nombre_estudio, anno_estreno, num_temporadas) VALUES
    ...
    function manejarPut($_conexion, $entrada){
        ...
        $sql = "UPDATE animes WHERE titulo = :titulo";
        $stmt = $_conexion -> prepare($sql);
        $stmt -> execute ([
            "titulo" => $entrada["titulo"]
        ]);
